...
class NpsExpertOutput(BaseModel):
    headline: str = Field(max_length=120, description="Plain-English insight headline ≤120 chars")
    narrative: str = Field(max_length=800, description="2-3 analytical sentences with [rXXXX] citation markers")
...
async def narrate_csat_insight(
    ...
    prompt = (
        ...
        "Write a headline (≤120 chars) and 2-3 sentence narrative. "
