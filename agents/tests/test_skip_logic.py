...
from agents.agents.skip_logic import SkipLogicAgent
from agents.schemas.output import SkipLogicInput, SkipLogicOutput, SkipLogicChange
...
async def test_skip_logic_adds_forward_rule(agent, questions):
    ...
    with patch("agents.agents.skip_logic.call_agent", new=AsyncMock(return_value=(output, credit))):
