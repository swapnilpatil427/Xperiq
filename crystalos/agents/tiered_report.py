...
from crystalos.tools.metrics import is_meaningful_text
...
class HeadlineReport(BaseModel):
    report_summary: str = Field(max_length=900, description="2-3 sentence overall summary of what respondents said")
...
class SummaryTheme(BaseModel):
    ...
    description: str = Field(max_length=900, description="2-3 sentence description of what respondents said about this theme")
    supporting_quotes: list[str] = Field(
...
class SummaryReport(BaseModel):
    report_summary: str = Field(max_length=1000, description="3-4 sentence overall summary")
