# CrystalOS — Experient Agent Framework

**Status:** Sprint 1 Complete — core framework implemented  
**Last updated:** 2026-06-03  
**Owner:** AI Platform team

> **Sprint 1 Complete — 2026-06-03:** Core framework (skill_registry, skill_runtime, tool_dispatcher), memory layer (L0-L4), observability (tracer, hallucination scorer, PII scrubber), and all 13 skills are implemented. See [QUICKSTART.md](../../crystalos/QUICKSTART.md) to add your first skill in 10 minutes. Gap tracking: [GAPS_STATUS.md](./GAPS_STATUS.md). Skills catalog: [SKILLS_CATALOG.md](./SKILLS_CATALOG.md).
...
|----------|---------------|
| **[PLATFORM_GUIDE.md](./PLATFORM_GUIDE.md)** | **Complete platform walkthrough — all 8 user flows, Mermaid diagrams, real-life scenarios. Start here.** |
| [QUICKSTART.md](./QUICKSTART.md) | Add a new CrystalOS skill in 10 minutes |
| [SKILLS_CATALOG.md](./SKILLS_CATALOG.md) | All 26 skills — purpose, tools, ownership, status |
| [TESTING.md](./TESTING.md) | Running tests, writing skill tests, CI matrix |
| [GAPS_STATUS.md](./GAPS_STATUS.md) | G1-G29 implementation tracking |
| [architecture.md](./architecture.md) | System diagram, layer breakdown, component ownership |
| [skills.md](./skills.md) | SKILL.md + EVALS.md format specification |
| [memory.md](./memory.md) | 4-layer memory system design (L0-L4) |
| [observability.md](./observability.md) | Langfuse, hallucination gate, PII scrubbing |
| [migration.md](./migration.md) | Agent → skill migration sprint plan |
| [a2a.md](./a2a.md) | A2A protocol integration design |

---

## What This Is

**CrystalOS** is the agent platform layer that powers Crystal, Copilot, and all AI capabilities in Experient. It is not a new framework built from scratch — it is a set of conventions and thin infrastructure layered on top of what already exists (LangGraph, OpenRouter, FastAPI, Redis, Postgres).
...
| Dimension | Before Sprint 1 | Sprint 1 Status | Target |
|-----------|---------|--------|--------|
| Adding a new agent | Edit Python, wire into graph | ✅ Create one SKILL.md file | Create one SKILL.md file |
| Prompts | Hardcoded in .py files | ✅ In SKILL.md + references/ | In SKILL.md + references/ |
| Evaluation | Inline LLM judge, no persistence | ✅ EVALS.md criteria + skill_examples DB | EVALS.md + Langfuse |
| Self-improvement | 2-retry correction loop only | ✅ Retry on failure; examples bank ready | EXAMPLES.md auto-filled + DSPy optimization |
| Tool discovery | 13 hardcoded tools | ✅ ToolDispatcher via plugin.json | Semantic search |
| Memory | 10 raw message turns (~5k tokens) | ✅ 4-layer (L0-L4) memory implemented | ~1.5k tokens in context |
| Observability | Prometheus + structlog only | ✅ tracer.py, hallucination_scorer.py, pii_scrubber.py | Langfuse + Gemini Flash judge |
| PII in traces | Unmitigated | ✅ pii_scrubber.py integrated into tracer | Scrubbed before any external service |
| External tools | Not connected | 📋 MCP stub in tool_dispatcher.py | MCP servers (Jira, Slack, etc.) |
| Inter-agent calls | Python imports | 📋 A2A protocol (future) | A2A protocol |
