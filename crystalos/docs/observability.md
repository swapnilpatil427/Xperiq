...
**Planned file:** `crystalos/lib/tracer.py`
...
**Planned file:** `crystalos/lib/hallucination_scorer.py`
...
**Planned file:** `crystalos/lib/pii_scrubber.py`

Reuse `_PII_PATTERNS` from `crystalos/lib/validators.py` — these are already compiled regex patterns covering names, emails, phone numbers, SSNs, and credit card numbers.
