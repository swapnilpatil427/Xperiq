...
Tasks:
- [ ] Create `crystalos/skills/` directory structure
...
- [ ] Write `crystalos/skills/plugin.json` — maps all 13 tool names to Python paths
...
Skills to create:
- `crystalos/skills/insight-narrator/` — SKILL.md, EVALS.md, empty EXAMPLES.md
- `crystalos/skills/specialist-nps/`
- `crystalos/skills/specialist-ces/`
- `crystalos/skills/specialist-csat/`
...
Skills to create:
- `crystalos/skills/survey-creator/`
- `crystalos/skills/copilot-analyst/`
- `crystalos/skills/survey-refiner/`
- `crystalos/skills/survey-qc/`
- `crystalos/skills/specialist-enps/`
- `crystalos/skills/specialist-custom/`
...
- [ ] Create `crystalos/skills/compliance-scanner/`
- [ ] Create `crystalos/skills/survey-recommender/`
...
CrystalOS migration is complete when:

1. `crystalos/skills/` contains all 12 skills with SKILL.md + EVALS.md + EXAMPLES.md
2. No agent logic lives in `crystalos/agents/*.py` — those files are deleted
...
6. `CLAUDE.md` "Adding a new agent" section says: create a folder in `crystalos/skills/`, no Python required
