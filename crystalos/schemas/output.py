...
from crystalos.lib.json_coerce import normalize_suggestions
...
class CopilotOutput(BaseModel):
    ...
    def _normalize_suggestions(cls, v):
        return normalize_suggestions(v, max_items=3)
...
class QuestionsResponse(BaseModel):
    ...
    recommendations:  list[dict] = Field(default_factory=list)
    compliance_risk:  str | None = None  # "low" | "medium" | "high" — set by check_compliance
