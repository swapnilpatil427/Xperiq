...
export const metadata: Metadata = {
  ...
  description: "Experient's Privacy Policy — how we collect, use, and protect your personal data.",
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose-legal space-y-10 font-body text-on-surface-variant leading-relaxed">
          <section>
            ...
            <p>
              Experient, Inc. (&quot;Experient,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your personal data. This Privacy Policy describes how we collect, use, store, and share information when you use the Experient platform, support site, or any related services.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>Survey responses you collect through Experient are processed on your behalf. You are the data controller for this information. We act as a data processor subject to your instructions and our Data Processing Agreement.</p>
          ...
          <section>
            ...
            <ul className="space-y-2">
              {[
                'To provide, operate, and improve the Experient platform',
          ...
          <section>
            ...
            <p>
              Experient&apos;s Crystal AI processes data you provide within the platform context to generate insights and recommendations. Crystal does not use your data to train general-purpose AI models. AI-generated content displayed in the support site is clearly labeled and has been reviewed by human editors.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>We retain personal data for as long as your account is active or as needed to provide services. Survey response data is retained per your configured retention policy. You may request deletion of your data at any time by contacting us at privacy@experient.ai.</p>
          </section>
          ...
          <section>
            ...
            <p>Experient processes data in the United States and European Union. For EEA users, we comply with GDPR data transfer requirements through Standard Contractual Clauses. Contact us for a copy of our Data Processing Agreement.</p>
          </section>
          ...
          <section>
            ...
            <div className="mt-3 p-4 bg-surface-container rounded-DEFAULT ghost-border font-mono text-sm">
              <p>Experient, Inc. — Privacy Team</p>
              <p>Email: privacy@experient.ai</p>
