...
**Files:** `agents/graphs/insights.py`, `agents/agents/crystal.py`
...
**Planned files:** `agents/lib/skill_registry.py`, `agents/lib/skill_runtime.py`
...
**Planned file:** `agents/lib/tool_dispatcher.py`
