> **Moved:** Authoritative copy lives in [`crystalos/QUICKSTART.md`](../../crystalos/QUICKSTART.md). This copy is kept here for design-doc cross-reference only.
...
```bash
cd crystalos && .venv/bin/pytest tests/test_skill_registry.py::test_real_skills_directory_loads -v
```
