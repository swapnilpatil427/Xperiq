...
/**
 * @param {number[]} series  ordered metric values (oldest → newest)
 * @param {number}   periods how many future points to project
 * @returns {{ slope:number, intercept:number, points:number[], direction:'up'|'down'|'flat', r2:number }|null}
 */
function linearForecast(series, periods = 7) {
