...
function OrbitRing({ radiusX, speed, color, tiltX = 0, tiltZ = 0 }: OrbitRingProps) {
...
function FloatingGem({ position, color, rotSpeed = 0.3, type = 'ico', scale = 1 }: FloatingGemProps) {
  ...
  const args: any = type === 'sphere' ? [1, 32, 32] : [1, 1];
