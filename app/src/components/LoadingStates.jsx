...
export function Spinner({ size = 24, color = '#2a4bd9', className = '' }) {
  return (
    <div
...
export function SurveyListSkeleton({ count = 4 }) {
  return (
...
export function OverlayLoader({ message = 'Saving…', visible = false }) {
  return (
    <AnimatePresence>
      {visible && (
        <motion.div
