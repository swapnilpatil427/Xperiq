...
export function SurveyTypeGallery({ templates = [], isLoading = false, selectedTypeId, onSelect, onContinue, onSkip, continueLabel }) {
  ...
  const filtered = useMemo(() => {
    let list = activeCategory === 'all' ? searchFiltered : searchFiltered.filter((s) => s.category === activeCategory);
    return list;
  ...
  const selectedType = selectedTypeId ? templateMap[selectedTypeId] : null;
