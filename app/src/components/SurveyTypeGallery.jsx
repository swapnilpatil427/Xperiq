...
function TypeCard({ type, selected, onSelect }) {
  ...
  return (
    ...
    >
      ...
      {/* Popular badge */}
      {type.recommended && (
        <div className="absolute top-3 right-3 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest"
          style={{
  ...
  return (
    <div className="w-full max-w-5xl pb-32">
      ...
      <div className="flex flex-col gap-4 mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-10 py-3 text-sm outline-none rounded-xl bg-white text-on-surface font-body"
      ...
      <div className="text-center mt-6">
        <button
          onClick={onSkip}
          className="text-xs font-semibold transition-colors text-on-surface-variant"
          ...
          <div className="max-w-5xl mx-auto px-6 py-4 flex items-center gap-4">
            {selectedType && (
              <>
                ...
                <button
                  onClick={onContinue}
                  className="flex items-center gap-2 px-6 py-3 text-white font-bold text-sm transition-all active:scale-95 rounded-xl flex-shrink-0 cta-glow"
